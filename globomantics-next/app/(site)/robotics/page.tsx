...
export const metadata: Metadata = {
  title: "Robotics | Globomantics",
};

export default function RoboticsPage() {
  return (
    <>
      <link rel="stylesheet" href="/css/style-robotics.css" />
        ...
        <div className="container">
          <div className="row">
            <div className="col-xs-12 col-sm-12 col-md-12 adj1 text-center">
              ...
              <h3>
                &ldquo;We look forward to fulfilling your human replacement
                needs.&rdquo;{" "}
              </h3>
              <p>
                But the applications don&apos;t end there. Tired of being on
                the hook for being yourself 24/7 365? Enter U bot v1. It&apos;s
                U but better! Using a proprietary DNA and behavior analysis
                technology, you can now customize our U class humanoid robotic
                platform to be an exact physical and behavioral replica of
                yourself! No more washing dishes, video chatting with your
                i-laws, or watching your children, replace yourself with U!{" "}
              </p>
              <p>
