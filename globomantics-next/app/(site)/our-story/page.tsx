...
export const metadata: Metadata = {
  title: "Our Story | Globomantics",
};

export default function OurStoryPage() {
  return (
    <>
      <link rel="stylesheet" href="/css/style-our-story.css" />
          ...
          <div className="row">
            <div className="col-xs-12 col-sm-8 col-md-8 adj_text">
              ...
              <p>
                ...
                circle of life. And from an old age Larry Shepard unlearned how
                to harness that circle and perpetuate it through more
                technology. He was graduating preschool, shaking his
                instructor&apos;s hand while holding up his brand new diploma
                when he saw his mother drop her phone. The device caught a
                twinkle in Larry&apos;s eyes as it fell, somehow still holding
                Larry perfectly in frame to immortalize the moment. That was the
                moment, the exact moment, when Larry knew what he would fix
                with his grant money. The world would never again feel the
                stinging pain experienced in one&apos;s belly when a smart phone
                hits the ground. Never again would a parent have to worry about
                their two year old practicing their dropping skills with their
                pocket technology. Localized anti gravity was born and neither
                phone nor Larry ever touched the ground again.{" "}
              </p>
        ...
        <div className="container">
          <div className="row">
            <div className="col-xs-12 col-sm-8 col-md-8 adj_text">
              ...
              <p>
                Larry may have been the innovative entreprenuerial spark that lit
                the fire of progress and unified the seven islands on this ball
                of water hurdling through space, but that fire still rages. From
                the gamma mutation labs on mercury to the cryolabs of Pluto and
                Eres, Globomantics barrels forward into the unkown, into the
